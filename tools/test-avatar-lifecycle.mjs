...
function harness(){
  ...
  const env={THREE:{...THREE,WebGLRenderer:Renderer},devicePixelRatio:1,performance:{now:()=>0},
    ...
    validateHiddenMotion(){},validateSecondaryMotion(){},springStep:state=>state,hairSecondaryDisplacement:()=>[0,0],
    hiddenOffset:()=>[0,0],hiddenRepairAmount:()=>0,drawBlink(){},drawMouth(){},
