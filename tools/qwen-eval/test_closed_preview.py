...
import unittest
import numpy as np
from build_eye_preview import closed_curve,extract_lid_ink,validate_base_identity,validate_masked_pixels,reconstruct_closed_skin,replace_closed_backing
