...
def visible_scene(subject, masks, face_support=None):
    ...
    textures={name:ndimage.binary_dilation(mask,iterations=1)&subject for name,mask in owners.items() if mask.any()}
