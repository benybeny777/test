...
- rig2dの出力先はrig2d-base/とし、未補完リグを完成扱いしない。completeで利用者採用承認済みQwen-Image-Edit-2511を管理下ComfyUIで実行し、原寸の閉眼・隠れ顔・耳を別々の局所マスクで編集してrig2d/へ公開する。DINO/SAMと承認済みの口は維持し、Layeredや別モデルへ無断変更しない。
