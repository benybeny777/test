...
比較仕様版4では、独立移動する髪の所有画素を顔だけでなく未分類等の全シーン素材から除く。むぎの候補IDは`c_46f929d3d046`。原画とのCPU中立合成も全RGBA一致を確認した。ただし、原画に一部だけ見えている耳を完全な耳へ補完したものではなく、髪をずらした時の耳の断片状露出は別途修正が必要。
